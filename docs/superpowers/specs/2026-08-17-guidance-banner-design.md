...
> **עדכון תיעוד 19.09.2026 — מסמך היסטורי/בדיקה מתוארכת.** GameBoard משתמש כעת ב־GuidanceBanner. תיאור הפיצול והטענה שאין רכיב מאוחד שייכים לשלב התכנון. להנחיות תחזוקה ראו frontend/UI_GUIDELINES.md; אין צורך להפעיל מחדש את תוכנית ההטמעה.
>
