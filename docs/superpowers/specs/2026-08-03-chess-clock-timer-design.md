...
> **עדכון תיעוד 19.09.2026 — מסמך היסטורי/בדיקה מתוארכת.** כלל התוספת אחרי תור בתכנון הישן הוחלף ב־delay: 10 שניות לפני ניכוי מהבנק, עם בנק של 30/60/120 שניות לנקודת יעד. אין לממש מחדש increment לפי המסמך הישן; ראו frontend/src/lib/clock.ts ומסמך חוקי המשחק.
>
