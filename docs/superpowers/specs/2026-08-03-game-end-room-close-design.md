...
> **עדכון תיעוד 19.09.2026 — מסמך היסטורי/בדיקה מתוארכת.** מחזור החיים הנוכחי כולל ניקוד סדרה, מסירת תוצאה מקושרת בתור, החלטות מנהל ותרגול AI. יש להבחין בין סוף משחקון לסוף מפגש; תרשים הסגירה הישן אינו חוזה מלא של כלל המסלולים הנוכחיים.
>
