...
> **עדכון תיעוד 19.09.2026 — מסמך היסטורי/בדיקה מתוארכת.** תכנון נקודתי של פתיחת משחק. אין להסיק ממנו ששעוני הסדרה או מדיניות ניתוק עדיין חסרים: קיימים שעון לפי יעד ועבודות מחזור חיים בשרת. זמני UI ופעולות פתיחה יש לאמת מול consumers.py ו־gameContext.tsx לפני שינוי.
>
