...
> **עדכון תיעוד 19.09.2026 — מסמך היסטורי/בדיקה מתוארכת.** שמות השחקנים עוברים דרך מצב המשחק ומוצגים ברכיבי הצד. שמות חסרים עדיין דורשים fallback. שמות ניתוח הם snapshots נפרדים בשירות הניתוח; אין להסיק צבע לפי מארח השולחן.
>
