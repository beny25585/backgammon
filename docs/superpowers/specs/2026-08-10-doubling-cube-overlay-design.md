...
> **עדכון תיעוד 19.09.2026 — מסמך היסטורי/בדיקה מתוארכת.** קוביית הכפלה, רכיבי אנימציה ובדיקות רכיב קיימים בקוד. המיקום, הצבעים ותנאי הנראות בתכנון הם היסטוריים; יש לשמור על התאמה לפורמט הכספי הנוכחי, לתקרת הקובייה ולכללי Crawford.
>
