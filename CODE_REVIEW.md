...
> **עדכון תיעוד 19.09.2026 — תכנון או ביקורת היסטורית.** ביקורת מ־18 ביולי נשמרת כרקע. מאז קיימים שרת סמכותי, ניקוד סדרה, קישור טורנירים, תורי מסירה ותרגול שרת. ממצאי הביקורת אינם רשימת כשלים מאומתת של הגרסה הנוכחית; יש לבדוק כל טענה מול הקוד לפני תיקון.
>
